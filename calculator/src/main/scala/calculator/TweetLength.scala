...
object TweetLength {
  ...
  /**
   * This function takes a Signal[String] of the text of a Tweet being typed, and
   * returns a Signal[Int] with the corresponding number of characters that are left
   * 
   * Use the function tweetLength to calculate the length of a given text
   */
